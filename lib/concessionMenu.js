...
// order below is the order on screen: drinks folded away at the top, the
// food everyone actually scrolls, then snacks and candy folded away
// underneath.
const DEFAULT_ITEMS = [
  { id: 'amc-large-soda', name: 'Large Soda', price: 7.49, note: '50\u00a2 off', section: 'Drinks', optionGroup: '' },
  { id: 'amc-icee', name: 'ICEE', price: 8.49, note: '', section: 'Drinks', optionGroup: '' },
  { id: 'amc-costa-coffee', name: 'Costa Coffee', price: 4.99, note: '', section: 'Drinks', optionGroup: '' },
  { id: 'amc-fairlife-chocolate-milk', name: 'Fairlife Chocolate Milk', price: 6.49, note: '', section: 'Drinks', optionGroup: '' },
  { id: 'amc-monster-energy', name: 'Monster Energy', price: 6.99, note: '', section: 'Drinks', optionGroup: '' },
  { id: 'amc-monster-ultra', name: 'Monster Ultra', price: 6.99, note: '', section: 'Drinks', optionGroup: '' },
  { id: 'amc-simply-pop-pineapple-mango', name: 'Simply Pop Pineapple Mango', price: 6.69, note: '', section: 'Drinks', optionGroup: '' },
  { id: 'amc-simply-pop-raspberry', name: 'Simply Pop Raspberry', price: 6.69, note: '', section: 'Drinks', optionGroup: '' },
  ...
  { id: 'amc-snack-cheez-it', name: 'Cheez-It Snack Mix', price: 7.99, note: '', section: 'Specialty Snacks', optionGroup: '' },
  { id: 'amc-snack-hello-panda', name: 'Hello Panda Cookies', price: 7.99, note: '', section: 'Specialty Snacks', optionGroup: '' },
  { id: 'amc-snack-homefree-cookies', name: 'Homefree Chocolate Chip Mini Cookies', price: 7.99, note: '', section: 'Specialty Snacks', optionGroup: '' },
  { id: 'amc-snack-katjies-gummies', name: 'Katjies Wild N Free Gummies', price: 7.99, note: '', section: 'Specialty Snacks', optionGroup: '' },
  { id: 'amc-snack-pringles-mingles', name: 'Pringles Mingles', price: 7.99, note: '', section: 'Specialty Snacks', optionGroup: '' },
  { id: 'amc-snack-trufru-strawberries', name: 'TruFru Chocolate Strawberries', price: 7.99, note: '', section: 'Specialty Snacks', optionGroup: '' },
  { id: 'amc-snack-welchs-zero-sugar', name: "Welch's Zero Sugar Fruit Snacks", price: 7.99, note: '', section: 'Specialty Snacks', optionGroup: '' },
