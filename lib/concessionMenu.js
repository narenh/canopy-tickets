...
// candy bars from burying the dozen things people usually want. '' means
// the main list. Nothing else reads it -- an item's section has no
// bearing on price, options, or what lands in an order.
//
// A section renders where its FIRST item falls in this array, so the
// order below is the order on screen, by kind, with the things most
// orders contain first.
const DEFAULT_ITEMS = [
  { id: 'amc-large-popcorn', name: 'Large Popcorn', price: 10.49, note: 'AMC Stubs Price ($1 off)', section: 'Popcorn & Soda', optionGroup: '' },
  { id: 'amc-large-soda', name: 'Large Soda', price: 7.49, note: 'AMC Stubs Price (50\u00a2 off)', section: 'Popcorn & Soda', optionGroup: '' },

  { id: 'amc-icee', name: 'ICEE', price: 8.49, note: '', section: 'More Drinks', optionGroup: '' },
  { id: 'amc-costa-coffee', name: 'Costa Coffee', price: 4.99, note: '', section: 'More Drinks', optionGroup: '' },
  { id: 'amc-fairlife-chocolate-milk', name: 'Fairlife Chocolate Milk', price: 6.49, note: '', section: 'More Drinks', optionGroup: '' },
  { id: 'amc-monster-energy', name: 'Monster Energy', price: 6.99, note: '', section: 'More Drinks', optionGroup: '' },
  { id: 'amc-monster-ultra', name: 'Monster Ultra', price: 6.99, note: '', section: 'More Drinks', optionGroup: '' },
  { id: 'amc-simply-pop-pineapple-mango', name: 'Simply Pop Pineapple Mango', price: 6.69, note: '', section: 'More Drinks', optionGroup: '' },
  { id: 'amc-simply-pop-raspberry', name: 'Simply Pop Raspberry', price: 6.69, note: '', section: 'More Drinks', optionGroup: '' },

  { id: 'amc-chicken-tenders', name: 'Chicken Tenders', price: 11.49, note: '', section: 'Hot Food', optionGroup: 'sauce' },
  { id: 'amc-popcorn-chicken', name: 'Popcorn Chicken', price: 8.99, note: '', section: 'Hot Food', optionGroup: 'sauce' },
  { id: 'amc-impossible-nuggets', name: 'IMPOSSIBLE Nuggets', price: 11.49, note: '', section: 'Hot Food', optionGroup: 'sauce' },
  { id: 'amc-extra-sauce', name: 'Extra Sauce', price: 0.99, note: '', section: 'Hot Food', optionGroup: 'sauce' },
  { id: 'amc-hot-dog', name: 'All-Beef Hot Dog', price: 8.49, note: '', section: 'Hot Food', optionGroup: '' },
  { id: 'amc-movie-nachos', name: 'MovieNachos', price: 8.99, note: '', section: 'Hot Food', optionGroup: '' },
  { id: 'amc-waffle-fries', name: 'Waffle Fries', price: 7.49, note: '', section: 'Hot Food', optionGroup: '' },
  { id: 'amc-mozzarella-sticks', name: 'Mozzarella Sticks w/ Marinara', price: 8.99, note: '', section: 'Hot Food', optionGroup: '' },
  { id: 'amc-street-corn-poppers', name: 'Street Corn Poppers', price: 10.19, note: '', section: 'Hot Food', optionGroup: '' },
  { id: 'amc-stone-fired-pizza', name: 'Stone Fired Pizza', price: 11.49, note: '', section: 'Hot Food', optionGroup: 'pizza' },
  { id: 'amc-pretzel-bites', name: 'Bavarian Pretzel Bites', price: 9.49, note: '', section: 'Hot Food', optionGroup: 'pretzel' },
  { id: 'amc-legend-pretzel', name: 'Bavarian Legend Pretzel', price: 17.49, note: '', section: 'Hot Food', optionGroup: 'pretzel' },
  { id: 'amc-cookies-8', name: 'Mini Chocolate Chip Cookies - 8 ct.', price: 7.49, note: '', section: 'Hot Food', optionGroup: '' },
  { id: 'amc-cookies-24', name: 'Mini Chocolate Chip Cookies - 24 ct.', price: 17.49, note: '', section: 'Hot Food', optionGroup: '' },

  { id: 'amc-snack-cheez-it', name: 'Cheez-It Snack Mix', price: 7.99, note: '', section: 'Packaged Snacks', optionGroup: '' },
  { id: 'amc-snack-hello-panda', name: 'Hello Panda Cookies', price: 7.99, note: '', section: 'Packaged Snacks', optionGroup: '' },
  { id: 'amc-snack-homefree-cookies', name: 'Homefree Chocolate Chip Mini Cookies', price: 7.99, note: '', section: 'Packaged Snacks', optionGroup: '' },
  { id: 'amc-snack-katjes-gummies', name: 'Katjes Wild N Free Gummies', price: 7.99, note: '', section: 'Packaged Snacks', optionGroup: '' },
  { id: 'amc-snack-pringles-mingles', name: 'Pringles Mingles', price: 7.99, note: '', section: 'Packaged Snacks', optionGroup: '' },
  { id: 'amc-snack-trufru-strawberries', name: 'TruFru Chocolate Strawberries', price: 7.99, note: '', section: 'Packaged Snacks', optionGroup: '' },
  { id: 'amc-snack-welchs-zero-sugar', name: "Welch's Zero Sugar Fruit Snacks", price: 7.99, note: '', section: 'Packaged Snacks', optionGroup: '' },
...
// Sections that start expanded rather than folded away. Between them
// they put popcorn, a soda and the chicken tenders on screen the moment
// the cart opens, which covers most of what most orders are -- the rest
// stays one tap away rather than in the way.
//
// Matched by name, so a section the host renames simply stops being one
// of these and starts collapsed. Anything not listed is collapsed, which
// is the right default for a list somebody is browsing rather than
// reaching into.
const DEFAULT_OPEN_SECTIONS = ['Popcorn & Soda', 'Hot Food'];
