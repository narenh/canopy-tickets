...
// its app adds on top. That fee is deliberately not modelled: nothing in
// this app adds anything to a cart that isn't a line in it, so what a
// friend is quoted is exactly the sum of what they picked.
//
// `note` is free text shown under the item, for the "why isn't this the
// price on the board" cases (see the 50c/$1 off ones). Nothing computes
// off it; `price` is what gets charged.
//
...
const DEFAULT_ITEMS = [
  { id: 'amc-large-soda', name: 'Large Soda', price: 7.49, note: '50\u00a2 off', optionGroup: '' },
  { id: 'amc-icee', name: 'ICEE', price: 8.49, note: '', optionGroup: '' },
  { id: 'amc-large-popcorn', name: 'Large Popcorn', price: 10.49, note: '$1 off', optionGroup: '' },

  { id: 'amc-chicken-tenders', name: 'Chicken Tenders', price: 11.49, note: '', optionGroup: 'sauce' },
  { id: 'amc-popcorn-chicken', name: 'Popcorn Chicken', price: 8.99, note: '', optionGroup: 'sauce' },
  { id: 'amc-impossible-nuggets', name: 'IMPOSSIBLE Nuggets', price: 11.49, note: '', optionGroup: 'sauce' },
  { id: 'amc-hot-dog', name: 'All-Beef Hot Dog', price: 8.49, note: '', optionGroup: '' },
  { id: 'amc-movie-nachos', name: 'MovieNachos', price: 8.99, note: '', optionGroup: '' },
  { id: 'amc-waffle-fries', name: 'Waffle Fries', price: 7.49, note: '', optionGroup: '' },
  { id: 'amc-mozzarella-sticks', name: 'Mozzarella Sticks', price: 8.99, note: '', optionGroup: '' },
  { id: 'amc-street-corn-poppers', name: 'Street Corn Poppers', price: 10.19, note: '', optionGroup: '' },
  { id: 'amc-stone-fired-pizza', name: 'Stone Fired Pizza', price: 11.49, note: '', optionGroup: 'pizza' },
  { id: 'amc-pretzel-bites', name: 'Bavarian Pretzel Bites', price: 9.49, note: '', optionGroup: 'pretzel' },
  { id: 'amc-legend-pretzel', name: 'Bavarian Legend Pretzel', price: 17.49, note: '', optionGroup: 'pretzel' },

  { id: 'amc-candy-airhead-soft-filled-bites', name: 'Airhead Soft Filled Bites', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-airhead-xtreme-bites', name: 'Airhead Xtreme Bites', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-buncha-crunch', name: 'Buncha Crunch', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-cookie-dough-bites', name: 'Cookie Dough Bites', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-chocolate-covered-pretzels', name: 'Chocolate Covered Pretzels', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-cinema-sweets-wild-berry-rings', name: 'Cinema Sweets Wild Berry Rings', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-haribo-gold-bears', name: 'Haribo Gold Bears', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-hi-chew-getaway', name: 'Hi-Chew Getaway', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-jr-caramels', name: 'Jr. Caramels', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-junior-mints', name: 'Junior Mints', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-lifesaver-gummies-fruit-rings', name: 'LifeSaver Gummies Fruit Rings', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-m-and-m-peanut', name: 'M&M Peanut', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-m-and-m-peanut-butter', name: 'M&M Peanut Butter', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-m-and-m-milk-chocolate', name: 'M&M Milk Chocolate', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-nerds-gummy-clusters', name: 'Nerds Gummy Clusters', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-nerds-very-berry-cluster', name: 'Nerds Very Berry Cluster', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-raisinets', name: 'Raisinets', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-red-vines', name: 'Red Vines', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-reeses-pieces', name: "Reese's Pieces", price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-skittles', name: 'Skittles', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-sour-patch-kids', name: 'Sour Patch Kids', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-sour-patch-watermelon', name: 'Sour Patch Watermelon', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-starburst-minis', name: 'Starburst Minis', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-trolli-sour-brite-crawlers', name: 'Trolli Sour Brite Crawlers', price: 6.99, note: '', optionGroup: '' },
  { id: 'amc-candy-welchs-fruit-snacks', name: "Welch's Fruit Snacks", price: 6.99, note: '', optionGroup: '' }
];
...
// different ones.
//
// The sauce list is transcribed from AMC's ordering screen at Metreon.
// The pretzel and pizza groups are deliberately EMPTY: those items do
// have their own choices, but inventing a list of flavors and toppings
// that reads as authoritative and is wrong is worse than shipping the
// group ready to fill in from the editor. An item whose group has no
// options behaves exactly like an item with no group until it does.
//
...
const DEFAULT_OPTION_GROUPS = [
  ...
  { id: 'pretzel', label: 'Pretzel Flavor', options: [] },
  { id: 'pizza', label: 'Pizza', options: [] }
];
